...
AddTextEntry('WT_GNADE_FLSH',"gdx_flashbang-FlashBang")
...
RegisterNetEvent('gdx_flashbang:FlashBangExplodeClient')
AddEventHandler('gdx_flashbang:FlashBangExplodeClient',function(x,y,z)
if Config.FlashBangEnabled then
